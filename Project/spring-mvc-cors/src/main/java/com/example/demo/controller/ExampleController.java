...
//		   produces = {"text/plain" }, // 결과의  MIME 타입
   ...
   public ModelAndView example3(
		   ...
		   @RequestParam Map<String, Object> map, // 파라미터를 받는 방법 #1
      ...
      // 컨트롤러 ==데이터==> 디스패처서블릿
      // Model: 데이터만, ModelMap(map 객체의 기능 지원), ModelAndView
   ...
   public String example4(HttpServletRequest req,
		   ...
		   // 파라미터 key ==> name = "a"
		   // 항상 같이 required = false, defaultValue = "100" 쓰인다.
		   @RequestParam(name = "a", required = false, defaultValue = "100") int age) {
	   
      System.out.println(id);
      System.out.println(age);
      
//      http://lovalhost:8080/mvc/seoul/sales/team1
//    	seoul/sales/team1
//      "/" 문자열을 잘라서 배열로 전환
