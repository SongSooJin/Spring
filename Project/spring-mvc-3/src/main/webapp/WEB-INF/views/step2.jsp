...
<body>
	...
	<form:form action="step3" method="post" commandName="member">
		<!--
			commandName="member" : 사용자가 작성한 데이터를 보관하는 객체 / 모델어트리뷰트의 키값
		...
		<table>
			<tr>
				<th>Address</th>
				<td><form:input type="text" path="address" /><br /> <form:errors
						path="address" cssClass="error" element="p" /></td>
						<!-- 그 항목의 에러를 따로 배치할 수 있다. -->
			</tr>
			<tr>
				<th></th>
