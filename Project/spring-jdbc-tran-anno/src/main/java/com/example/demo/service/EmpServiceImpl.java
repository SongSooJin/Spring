...
public class EmpServiceImpl implements EmpService {
	...
	public int insert(Emp emp) throws Exception {
		...
		// 트랜잭션과 관련한 4가지 속성을 어떻게 적용 할 것인가와 관련한 정보를 취급하는 객체 
		...
		// 조회쿼리를 수행 할 때 true로 변경하면
		// 이 트랜잭션을 제치고 다른 트랜잭션이 먼저 작업하는것을 허용한다.
		transactionDefinition.setReadOnly(false);
		
		// 이 객체를 이용하여 나중에 Rollback 또는 Commit을 적용 할때 사용한다.
