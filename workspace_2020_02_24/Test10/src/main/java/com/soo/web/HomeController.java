...
public class HomeController {
	...
	//service와 연결
		...
		public ModelAndView login(LoginDTO dto, HttpServletRequest request) throws Exception {
			...
			//2. 로그인 불가 = / 
				...
				mv.setViewName("redirect:/?error=login");
			}
			return mv;
		}
	...
	public ModelAndView join(LoginDTO dto, HttpServletRequest request) throws Exception {
	...
	public @ResponseBody String checkID(HttpServletRequest request) throws Exception {
		...
		int result = iotService.checkID(id);
	...
	public String joinAction(HttpServletRequest request) throws Exception {
